...
if (isset($_SESSION['adminUsername'])){
    ...
    if ($do == 'manage'){?>
        <div id="content">
                        <h1 class="text-center">كل الخدام</h1>
                <div class="container">
    ...
    <?php
            ...
            <div id="content">
                        <h1 class="text-center">إضافه خادم</h1>
                <div class="container">
                    <div role="content">
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-6">
                                            <label class="input"> <i class="icon-prepend fa fa-phone"></i>
                                                <input type="tel" name="phone" placeholder="رقم التليفون" data-mask="(999) 999-9999">
                                            </label>
                                        </section>
                                        <section class="col col-6">
                                        ...
                                        <section class="col col-6">
                                            <label class="input"> <i class="icon-prepend fa fa-lock"></i>
                                                <input type="password" name="confirmpassword" placeholder="  تاكيد كلمه السر" >
                                            </label>
                                        </section>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset>
                                    <div class="row">
                                        <section class="col col-5">
                                            <label class="select">
                                                <select name="country">
                                                    <option value="0" selected="" disabled="">اختر اسم الكنيسه</option>
                                    ...
                                    <div class="row">
                                        <section class="col col-10">
                                            <label class="input state-error">
                                                <input type="text" name="card" placeholder="Card number" data-mask="9999-9999-9999-9999" aria-required="true" aria-invalid="true" aria-describedby="card-error">
                                            </label><em id="card-error" class="invalid">Please enter a valid credit card number.</em>
                                        </section>
